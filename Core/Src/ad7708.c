 ...
 * @return 0: case of success, error code otherwise.
 */
static StatusTypeDef spiRecieve(ad7708_dev *dev, uint8_t *data, uint16_t len);
...
StatusTypeDef ad7708_calibrate(ad7708_dev *dev, AD7708_Channel channel)
{
    ...
    status = ad7708_modeConfig(dev, AD7708_InternalZeroCalibration, AD7708_CHCON, AD7708_REFSEL, AD7708_CHOP, AD7708_NEGBUF, AD7708_OSCPD); // TODO: Sytem or Internal calibration??

    if (ad7708_waitForIdle(dev, 200) == AD7708_OK)
    {
        status = ad7708_modeConfig(dev, AD7708_InternalFullCalibration, AD7708_CHCON, AD7708_REFSEL, AD7708_CHOP, AD7708_NEGBUF, AD7708_OSCPD);
        if (ad7708_waitForIdle(dev, 200) == AD7708_OK)
        {
            return AD7708_OK;
        }
