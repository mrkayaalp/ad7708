 ...
 * @param[in] negbuf - 0: pseudo-differential mode, 1: Not using AINCOM
 * @param[in] oscpd -  0: Ossilator not shut off in standby mode, 1: Ossilator shut off in standby mode
 * @return 0: case of success, error code otherwise.
 */
