...
#define AD7708_CS_Pin SPI1_CS_Pin
#define AD7708_CS_GPIO_Port SPI1_CS_GPIO_Port
#define AD7708_RDY_Pin RDY_Pin //EXTI Falling Edge
#define AD7708_RDY_GPIO_Port RDY_GPIO_Port
#define AD7708_INTF hspi1 
